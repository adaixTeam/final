...
$result = mysqli_query($mysqli, "SELECT * FROM reservation ORDER BY idr DESC");

$count_client = mysqli_query($mysqli, "SELECT * FROM clients");
$count_car = mysqli_query($mysqli, "SELECT * FROM users WHERE st=0");
$count_contrat = mysqli_query($mysqli, "SELECT * FROM contrats");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <!--h1 class="custom-font">Les <strong>Réservations</strong></h1!-->
                                    <a href="ajoute_reservation.php" tabindex="0" class="btn btn-success"><i class="fa fa-plus mr-5"></i> Ajoute une reservation</a>
                                    <!--ul class="controls">
                                        <li>
                                            <a  tabindex="0"  href="ajoute_reservation.php"><i class="fa fa-plus mr-5"></i> Ajoute une reservation</a>
                                        </li>
                                        <li class="dropdown">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tr>
                                                ...
                                                <th>Date de Départe</th>
                                                <th>Durée du Location</th>
                                                <th>Action</th>
                                            ...
                                            <tbody>
                                              <?php
                                                ...
                                                echo "<td>".$res['duree']."</td>";
                                            		echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"editres.php?id=$res[idr]\"><i class='fa fa-edit'></i></a> | <a style='background-color:#d9534f;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"deleteres.php?id=$res[idr]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                            	}
                                            	?>
                                            </tbody>
                                        </table>

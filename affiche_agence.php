                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="tables-agence.php"><i class="fa fa-building-o"></i>Agences</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-agence.php">Agences</a>
                                </li>
                                <li>
                                    <a href="#">Informations sur l'agence</a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font">Informations sur <strong>l'agence</strong></h1>

...
if(isset($_POST['update']))
{
  ...
  $dater = mysqli_real_escape_string($mysqli, $_POST['dater']);
	...
	if( empty($cin) || empty($nom) || empty($matricule)|| empty($dater)|| empty($dated)) {
...
$result = mysqli_query($mysqli, "UPDATE reservation SET cin='$cin',nom='$nom',matricule='$matricule',dater='$dater',dated='$dated',duree='$duree'WHERE idr=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM reservation WHERE idr = $id");
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li class="active"><a href="tables-reservation.php"><i class="fa fa-edit"></i>Les Réservations</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
																						...
																						<li>
												                      <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
												                      <li><a href="tables-datatables.php"><i class="fa fa-square"></i>Black Liste</a></li>
												                      <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-reservation.php">Réservation</a>
                                </li>
																<li>
                                    <a href="#">Modifier Réservation</a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Modifier la <strong>Réservation</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body">
                                  <!-- /.panel-heading -->
																	...
																	<form style="padding:3%;" name="form1" method="post" action="editres.php">
				                          <fieldset >
															    ...
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="Nom Complete">Nom du client *  </label>
															      <div class="col-md-5">
															    ...
															    <!-- Text input Modèle-->
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="Matricule du Voiture *">Matricule du Voiture *</label>
															      <div class="col-md-5">
															    ...
															    <!-- Text input Couleur-->
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="Date de Reservation">Date de Reservation*</label>
															      <div class="col-md-5">
															    <input type="date" name="dater" class="form-control" value="<?php echo $dater;?>">
															    ...
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="delivre">Date de Départe*</label>
															      <div class="col-md-5">
															    <input type="date" name="dated" class="form-control" value="<?php echo $dated;?>">
															    ...
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="Durée">Durée du Location</label>
															      <div class="col-md-5">
															      <input type="number" name="duree" class="form-control" value="<?php echo $duree;?>">
				                          ...
				                          <div class="modal-footer">
				                            <a href="tables-reservation.php"> <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button> </a>

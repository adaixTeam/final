                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li><a href="tables-datatables.php"><i class="fa fa-folder-open"></i>Les Contrats</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-datatables.php">Véhicules</a>
                                </li>
                                <li>
                                    <a href="#">Ajouter Véhicule</a>
                                </li>
                            </ul>
                    ...
                    <div class="row" style="width:70%;margin:0 auto;padding:20px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Ajouter une<strong> Véhicule</strong></h1>
                                    <ul class="controls">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Numéro du châssis">Numéro du châssis *</label>
                              <div class="col-md-5">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-5">
                              <td><input type="date" name="assurance" class="form-control"required></td>
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="autorisation">Autorisation de Circulation *</label>
                              <div class="col-md-5">
                              <input type="date" name="autorisation" class="form-control"required></td>
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Visitetechnique">Visite technique *</label>
                              <div class="col-md-5">
                            <td><input type="date" name="visite" class="form-control"required></td>

                              </div>
                            </div>
                            <br><br>
                           <!-- <div class="form-group">
                                <label class="col-md-4 control-label" for="Visitetechnique" style="padding-top: 10px;">Filtre Hulle *</label>
                            ...
                            <br><br>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="Visitetechnique">Filtre Air *</label>
                                <div class="col-sm-5">
                            ...
                            <br><br>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="Visitetechnique">Filtre Carburant *</label>
                                <div class="col-sm-5">
                            ...
                            <!-- Text input Vidange-->
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Dernier_KM">Dernier KM Marque</label>
                              <div class="col-md-5">
                              <input type="number" name="dernier" class="form-control">

                              </div>
                            </div><br><br>
                            <!-- Text input Vidange-->
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Vidange">Vidange</label>
                              <div class="col-md-5">
                              <input type="number" name="vidange" class="form-control">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Chaine_distribution">Chaine de distribution</label>
                              <div class="col-md-5">
                            <input type="number" name="chaine" class="form-control">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Carburant moteur">Carburant moteur *</label>
                              <div class="col-md-5">
                            ...
                            <!-- Text input Prix-->
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="Prix">Prix/jour</label>
                              <div class="col-md-5">

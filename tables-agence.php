                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="tables-datatables.php"><i class="fa fa-building-o"></i>Agences</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->

                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-employe.php"><i class="fa fa-user"></i>Employée</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a href="tables-entrer_caisse.php"><i class="fa fa-square"></i>Les entrées</a></li>
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <br><br!-->
                                    <a href="ajoute_agence.php" tabindex="0" class="btn btn-success"><i class="fa fa-plus mr-5"></i> Ajoute une Agence</a>
                      ...
                      //while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array
                        ...
                        echo "<td><a href=\"affiche_agence.php?ida=$res[ida]\">view</a> |<a href=\"editag.php?ida=$res[ida]\">Edit</a> | <a href=\"deleteagence.php?ida=$res[ida]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                                }
                                                ?>
                                            </tbody>
                                        </table>

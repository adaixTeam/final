                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-clients.php">Les Clients</a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font">Ajouter un <strong>Client</strong></h1>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <form action="addc2.php" method="post" name="form1"><br><br>
                                                <fieldset>
                                                    <!-- Marque -->
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="Nom Complete">Nom Complete *  </label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <!-- Text input Couleur-->
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="permi">N° Permi</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="delivre">Délivré le *</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="CIN">CIN \ Passeport*</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="Nationalité">Nationalité*</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="clientType">Type de client *</label>
                                                        <div class="col-md-5">
                                                            <script>
                                                                function val() {
                                                    ...
                                                    <div id="pro" style="display:none">
                                                        <br><br>
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="rs">Raison sociale *</label>
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="fj">Forme Juridique *</label>
                                                            <div class="col-md-5">

...
{
$id = mysqli_real_escape_string($mysqli, $_POST['idc']);
...
echo "<font color='red'>Ville field is empty.</font><br/>";
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE clients2 SET nom='$nom',telephone='$telephone',permi='$permi',delivre='$delivre',cin='$cin',adresse='$adresse',nationalite='$nationalite',ville='$ville'WHERE idc=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM clients2 WHERE idc=$id");
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                  <!-- /.panel-heading -->
																	...
																	<form style="padding:3%;" name="form1" method="post" action="modifier_client.php">
				                          <fieldset >
				                          ...
				                          <!-- Marque -->
															    ...
															    <div class="form-group">
															      ...
															      <div class="col-md-5">
															    <input type="text" name="permi" class="form-control" value="<?php echo $permi;?>">
															    ...
															    <div class="form-group">
															      ...
															      <div class="col-md-5">
															    <input type="date" name="delivre" class="form-control"value="<?php echo $delivre;?>">
															    ...
															    <div class="form-group">
															      ...
															      <div class="col-md-5">
															      <input type="text" name="nationalite" class="form-control"value="<?php echo $nationalite;?>">

...
$result = mysqli_query($mysqli,"SELECT * FROM categorie ORDER BY id DESC");

if(isset($_POST['Submit'])){
    $cat = mysqli_real_escape_string($mysqli,$_POST['categorie']);
    if(empty($cat)){
        echo '<script language="javascript">';
        echo 'alert("Entrer Une Categorie")';
        echo '</script>';
    }
    else{
        $result = mysqli_query($mysqli, "INSERT INTO categorie(categorie) VALUES('$cat')");
        echo '<script language="javascript">';
        echo 'alert("Catégorie est ajouté")';
        echo '</script>';
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-reservation.php"><i class="fa fa-edit"></i>Les Réservation</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            ...
                                            <li >
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="tables-categorie.php"><i class="fa fa-search"></i>Les Catégories</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>Catégorie</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body" style="padding-left: 37%; padding-top: 0%;">
                                    <form action="#" method="post" style="width:50%">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="categorie" class="form-control" id="cat" required><br>
                                            <input type="submit" name="Submit" class="btn btn-success" id="butt" value="Ajouter">
                                        </div>
                                    </form>
                                </div>
                                <!-- tile body -->
                                            ...
                                            <tbody>
                                                <?php
															                      	...
															                      	while($res = mysqli_fetch_array($result)) {
															                      		...
															                      		echo "<td><a class='btn btn-danger' href=\"delete_cat.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
															                      	}
															                      	?>
                                            </tbody>
                                        </table>

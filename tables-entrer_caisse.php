...
$result_caisse = mysqli_query($mysqli,"SELECT total FROM caisse");
...
if(isset($_POST['add']))
{
	...
	if(empty($categorie) && empty($montant) && empty($label) && empty($date)) {
		...
		//updating the table
		$add = mysqli_query($mysqli, "INSERT INTO entrer(categorie,montant,date,label) VALUES('$categorie','$montant','$date','$label')");

		//redirectig to the display page. In our case, it is index.php
		header("Location: tables-entrer_caisse.php");
	}
}
?>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="tables-cherche.html"><i class="fa fa-search"></i>Recherche</a></li>
																						...
																						<li >
																								...
																								<ul>
																										<li class="active"><a href="tables-entrer_caisse.php"><i class="fa fa-reply-all"></i>Les entrées</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>Entres</strong></h1>
                                    <ul class="controls">
                                ...
                                <form action="tables-entrer_caisse.php" style="width:50%;margin-top:10px;" method="post">
                                    <div class="form-group">
                                        <span>Par : </span><br><br>
                                        <select name="categorie" id="" class="form-control" required>
                                            <option value="">Select Categorie</option>
                                            <option value="check">Chéck</option>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <table class="table table-custom" id="editable-usage">
                                        	...
                                        	while($res = mysqli_fetch_array($result_entrer)) {
                                        		echo "<tr>";
                                            	echo "<td>".$res['categorie']."</td>";
                                              echo "<td>".$res['montant']." Dhs</td>";
                                              echo "<td>".$res['label']."</td>";
                                              echo "<td>".$res['date']."</td>";
                                        		echo "<td><a style='background-color:#d9534f;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"delete_entrer.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                              echo "</tr>";
                                        	}
                                        	?>
                                            </tbody>

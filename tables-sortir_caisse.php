...
if (isset($_GET['logout'])) {
  ...
  header("location: login.php");
	...
	$result_entrer = mysqli_query($mysqli,"SELECT * FROM entrer ORDER BY id DESC");
	$result_sortie = mysqli_query($mysqli,"SELECT * FROM sortie ORDER BY id DESC");
	$result_caisse = mysqli_query($mysqli,"SELECT * FROM caisse ORDER BY id DESC");

	$result = mysqli_query($mysqli,"SELECT * FROM caisse");
    ...
    $montant= mysqli_real_escape_string($mysqli, $_POST['montant']);
    $label= mysqli_real_escape_string($mysqli, $_POST['label']);
    $date= mysqli_real_escape_string($mysqli, $_POST['date']);

	// checking empty fields
	if(empty($categorie) && empty($montant) && empty($label) && empty($date)) {
        return;
	} else {
        $b = $tot - $montant;
        $update = mysqli_query($mysqli, "UPDATE caisse SET total='$b'");
		//updating the table
		$add = mysqli_query($mysqli, "INSERT INTO sortie(categorie,montant,date,label) VALUES('$categorie','$montant','$date','$label')");

		//redirectig to the display page. In our case, it is index.php
		header("Location: tables-sortir_caisse.php");
	}
	}
	?>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li >
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="tables-sortir_caisse.php"><i class="fa fa-share-square"></i>Les sorties</a></li>
                                            ...
                                            <!--li><a href="index.html"><i class="fa fa-bar-chart-o"></i> <span>Les Statistiques</span></a></li!-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>sortie</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body" style="padding-left: 37%; padding-top: 0%;">
                                    <form action="tables-sortir_caisse.php" style="width:50%;margin-top:10px;" method="post">
                                        <div class="form-group">
                                            <span>Catégorie</span><br><br>
                                            <select name="categorie" id="" class="form-control" <re></re>>
																					<option value="">Select Categorie</option>
																					<?php
																					$result = mysqli_query($mysqli,"SELECT * FROM categorie ORDER BY id ASC");
																					while($res = mysqli_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array
																					echo "<option value=".$res['categorie'].">".$res['categorie']."</option>";
																					}
																					?>
																			</select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input name="montant" step="0.0001" type="number" id="prix" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <span>Label</span><br><br>
                                            <input name="label" type="text" id="label" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <span>Date</span><br><br>
                                            <input style="width:50%" name="date" type="date" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <span>Ajouter Le Montant</span><br><br>
                                            <input name="add" type="submit" id="Submit" value="Ajouter" class="btn btn-success">
                                        </div>
                                    </form>
                                </div>
                                <!-- tile body -->
                                        ...
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tbody>
                                                <?php
															                      	...
															                      	while($res = mysqli_fetch_array($result_sortie)) {
															                      		echo "<tr>";
															                          	echo "<td>".$res['categorie']."</td>";
															                            echo "<td>".$res['montant']." Dhs</td>";
															                            echo "<td>".$res['label']."</td>";
															                            echo "<td>".$res['date']."</td>";
															                      		echo "<td><a class='btn btn-success' href=\"edit_cat.php?id=$res[id]\"><i class='fa fa-edit'></i></a> | <a class='btn btn-danger' href=\"delete_sortie.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
															                      	}
															                      	?>
                                            </tbody>
                                        </table>

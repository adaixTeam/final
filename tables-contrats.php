...
$result = mysqli_query($mysqli, "SELECT * FROM contrats ORDER BY idcont DESC"); // using mysqli_query instead
$zak = mysqli_query($mysqli, "SELECT * FROM clients where st='0' ORDER BY idc DESC"); // using mysqli_query instead
$zak1 = mysqli_query($mysqli, "SELECT * FROM users where st='0' ORDER BY id DESC");
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <button tabindex="0" style="font-weight:bold;padding:8px;border-radius:2px" class="btn btn-cyan" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-plus mr-5"></i> Ajoute une contrat</button>
                                    <!--h1 class="custom-font">Les <strong>Contrats</strong></h1>
                                    <ul class="controls">
                                        <li>
                                            <a href="ajouter_contrat.php" tabindex="0"><i class="fa fa-plus mr-5"></i> Ajoute une Contrat</a>
                                        </li>
                                        <li class="dropdown">
                    	...
                    	while($res = mysqli_fetch_array($result)) {
                    		echo "<tr>";
                    		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['idcont']."</td>";
                        ...
                        echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['matricule']."</td>";
                    		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['datedep']."</td>";
                    		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['dateret']."</td>";
                    		echo "<td style='padding-bottom: 25px;padding-top: 25px;'><a style='background-color:#22beef;color:#fff;padding: 10px;border-radius: 10px;' href=\"modifier_contrats.php?id=$res[idcont]\"><i style='padding:10px;' class='fa fa-edit'></i></a> | <a style='background-color:#d9534f;color:#fff;padding-bottom: 10px;padding-top: 10px;padding-right: 10px;padding-left: 10px;border-radius: 10px;' href=\"sup_contrats.php?id=$res[idcont]\" onClick=\"return confirm('Voulez-Vous Vraiment Supprimer Cette Contrats?')\"><i style='padding:10px;' class='fa fa-trash'></i></a></td>";
                    	}
                    	?>
                                            </tbody>
                                        </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title custom-font">Ajouter une nouvelle Contrts</h3>
                    </div>

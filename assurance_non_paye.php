...
$result = mysqli_query($mysqli, "SELECT * FROM users where assurance <= Now()"); // using mysqli_query instead
$result1 = mysqli_query($mysqli, "SELECT count(*) FROM users where assurance <= Now()");
          ...
          <div class="col-md-8" style="display: inline;float: none;">
            ...
            <section class="tile">
                ...
                <div class="tile-header dvd dvd-btm">
                    <h1 class="custom-font"><strong>Assurance</strong> Non Payé</h1>
                    <ul class="controls">

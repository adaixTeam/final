...
$result2 = mysqli_query($mysqli, "SELECT * FROM reparation ORDER BY id DESC");// using mysqli_query instead
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="ajoute_devis.php"><i class="fa fa-book"></i>Devis</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="ajoute_devis.php">Réparation</a>
                                </li>
                                <li>
                                    <a href="#">Ajouter Réparation</a>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- tile --> <button class="btn btn-success mb-10" data-toggle="modal" data-target="#splash" data-options="splash-ef-3">Ajouter Réparation</button>
                            <section class="tile">
                                        ...
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tbody>
                                              ...
                                              while($res = mysqli_fetch_array($result2)) {
                                                ...
                                                echo "<tr>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['dateReparation']."</td>";
                                                    echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['voiture']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['typeReparation']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['frais']."</td>";
                                                  echo "<td style='padding-bottom: 25px;padding-top: 25px;'><img style='width:50px;height:50px' src='$a'></td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'><a style='background-color:#22beef;color:#fff;padding: 10px;border-radius: 10px;' href=\"modifier_reparation.php?id=$res[id]\"><i style='padding:10px;' class='fa fa-edit'></i></a>| <a style='background-color:#d9534f;color:#fff;padding: 10px;border-radius: 10px;' href=\"delete_reparation.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i style='padding:10px;' class='fa fa-trash'></i></a></td>";
                                              }
                                              ?>
                                            </tbody>
                                        </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title custom-font">Ajouter Réparation</h3>
                    </div>
                        ...
                        <section class="tile">
                            ...
                            <div id="page-wrapper">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <form action="addRep.php" method="post">
                                                    ...
                                                    <div class="form-group" style="padding-top:20px;">
                                                        <label class="col-md-4 control-label" for="selectbasic"> Voiture </label>

                                                        <div class="col-md-4">
                                                            <select name="voiture" id="selectbasic" name="selectbasic" class="form-control">
                              ...
                              <?php endwhile;?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="dateRep">Date de Réparation</label>
                                                        <div class="col-md-4">
                                                            <input name="dateReparation" type="date" placeholder="" class="form-control input-md" id="text1">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="textinput">Type de Réparation</label>
                                                        <div class="col-md-4">
                                                            <input name="typeReparation" type="text" placeholder="" class="form-control input-md" id="text3">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="textinput">Frais de réparation (TTC) </label>
                                                        <div class="col-md-4">
                                                            <input name="frais" type="number" placeholder="" class="form-control input-md" id="frais">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="textinput">Etat </label>
                                                        <div class="col-md-4">
                                                            <select name="etat" class="form-control" required>
                                                                    <option style="display: none;" value="" >Etat de voiture</option>
                                                                    <option value="enPanne">En Panne</option>
                                                                    <option value="enCirculation">En Circulation</option>
                                                                </select>
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>

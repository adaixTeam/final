...
$result = mysqli_query($mysqli, "SELECT * FROM employes ORDER BY ide DESC"); // using mysqli_query instead
?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-agence.php"><i class="fa fa-building-o"></i>Agences</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->

                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="tables-employe.php"><i class="fa fa-user"></i>Employée</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            <!--li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="tables-categorie.php"><i class="fa fa-search"></i>Les Catégories</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <br><br!-->
                                    <a href="ajoute-employe.php" tabindex="0" class="btn btn-success"><i class="fa fa-plus mr-5"></i> Ajoute un employé</a>
                                    <!--ul class="controls">
                                        <li>
                                            <a href="ajoute_clients.php" tabindex="0"><i class="fa fa-plus mr-5"></i> Ajoute un client </a>
                                        </li>
                                        <li class="dropdown">
                                        ...
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tbody>
                                                ...
                                                echo "<td>".$res['telphone']."</td>";
                                            		...
                                            		echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"modifier_employe.php?id=$res[ide]\"><i class='fa fa-edit'></i></a> | <a style='background-color:#d9534f;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"delete_employe.php?id=$res[ide]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                            	}
                                            	?>
                                            </tbody>
                                        </table>

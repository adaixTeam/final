                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <!--h1 class="custom-font">Les <strong>Véhicules</strong></h1>
                                    <br><br!-->
                                    <a href="ajoute.php" tabindex="0" class="btn btn-success"><i class="fa fa-plus mr-5"></i> Ajoute une voiture</a>
                                    <!--ul class="controls">
                                        <li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tr>
                                                <th>Marque</th>
                                                <th>Matricule</th>
                                                <th>Dernier KM marqué</th>
                                                <th>Prochaine Chaine</th>
                                                <th>Etat</th>
                                            ...
                                            <tbody>
                                              ...
                                              while($res = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td>".$res['marque']."</td>";
                                                    ...
                                                    echo "<td>".$res['dernier']." KM</td>";
                                                echo "<td>".$res['prochaine_chaine']." KM</td>";
                                                      echo "<td style='padding-bottom: 25px;padding-top: 25px;'><img style='width:50px;height:50px' src='$a'></td>";
                                                echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"modifier_voitur.php?id=$res[id]\"><i class='fa fa-edit'></i></a>| <a style='background-color:#d9534f;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                                  }
                                                  else if( $r <= 500 ){
                                                      $a = 'images/alert.png';
                                                      echo "<tr>";
                                                echo "<td>".$res['marque']."</td>";
                                                    echo "<td>".$res['matricule']."</td>";
                                                    echo "<td>".$res['dernier']." KM</td>";
                                                echo "<td>".$res['prochaine_vidange']." KM</td>";
                                                      echo "<td style='padding-bottom: 25px;padding-top: 25px;'><img style='width:50px;height:50px' src='$a'></td>";
                                                echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"modifier_voitur.php?id=$res[id]\"><i class='fa fa-edit'></i></a>| <a style='background-color:#d9534f;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-trash'></i></a></td>";
                                                  } else{

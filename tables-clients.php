...
$result = mysqli_query($mysqli, "SELECT * FROM clients2 ORDER BY idc DESC"); // using mysqli_query instead
?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="tables-clients.php"><i class="fa fa-users"></i>Les Clients</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            ...
                                            <li>
                                                ...
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-datatables.php"><i class="fa fa-paste"></i>Les Factures</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->

                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-factures.php"><i class="fa fa-building-o"></i>Agence</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-factures.php"><i class="fa fa-user"></i>Employee</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            <!--li>
                                            ...
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-reservation_onligne.php"><i class="fa fa-signal"></i>Résérvation Online</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <button tabindex="0" style="font-weight:bold;padding:8px;border-radius:2px" class="btn btn-cyan" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-plus mr-5"></i> Ajoute un client</button>
                                        ...
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tbody>
                                            	...
                                            	while($res = mysqli_fetch_array($result)) {
                                            		echo "<tr>";
                                            		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['nom']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['telephone']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['permi']."</td>";
                                            		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['delivre']."</td>";
                                            		echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['cin']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['ville']."</td>";
                                                echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['adresse']."</td>";
                      													echo "<td style='padding-bottom: 25px;padding-top: 25px;'>".$res['nationalite']."</td>";

                                            		echo "<td><a style='background-color:#22beef;color:#fff;padding: 10px;border-radius: 10px;' href=\"modifier_client.php?id=$res[idc]\"><i style='padding:10px;' class='fa fa-edit'></i></a>| <a style='background-color:#d9534f;color:#fff;padding-bottom: 10px;padding-top: 10px;padding-right: 10px;padding-left: 10px;border-radius: 10px;' href=\"delete_client.php?id=$res[idc]\" onClick=\"return confirm('Voulez-Vous Vraiment Supprimer Ce Client?')\"><i style='padding:10px;' class='fa fa-trash'></i></a></td>";
                                            	}
                                            	?>
                                            </tbody>
                                        </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 style="font-weight:bold" class="modal-title custom-font">Ajouter un client</h3>
                    </div>
                            ...
                            <div id="page-wrapper">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <form action="addc2.php" method="post" name="form1"><br><br>
                                                <fieldset>
                                                    <!-- Marque -->
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="Nom Complete">Nom Complete *  </label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="sexe ">Sexe  *</label>
                                                        <div class="col-md-5">
                                                            <select id="sexe" name="sexe" class="form-control" required>
                                                    <option style="display: none;" value="" >Sexe</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="naissance">Date de Naissance *  </label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="lieu_naissance">Lieu de Naissance *  </label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="profession">Profession  </label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <!-- Text input Modèle-->
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="telephone">Téléphone *</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="email">Email *</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <!-- Text input Couleur-->
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="permi">N° Permi</label>
                                                        <div class="col-md-5">
                                                            <input type="text" name="permi" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="delivre">Délivré le *</label>
                                                        <div class="col-md-5">
                                                            <input type="date" name="delivre" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="CIN">CIN \ Passeport*</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="ville">ville *</label>
                                                        <div class="col-md-5">
                                                            <td><input type="text" name="ville" class="form-control" required></td>
                                                    ...
                                                    <!-- File Button -->
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="Adresse">Adresse *</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="Nationalité">Nationalité*</label>
                                                        <div class="col-md-5">

                                                            <select id="nationalite" name="nationalite" class="form-control" required>
                                                                    <option style="display: none;" value="" >Nationalite</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:bold" class="col-md-4 control-label" for="clientType">Type de client *</label>
                                                        <div class="col-md-5">
                                                            <script>
                                                                function val() {
                                                                    d = document.getElementById("clientType").value;
                                                                    if (d == "professionel") {
                                                            ...
                                                            <select onchange="val()" id="clientType" name="clientType" class="form-control" required>
                                                                    <option style="display: none;" value="" >Type de client</option>
                                                    ...
                                                    <div id="pro" style="display:none">
                                                        <br><br>
                                                        <div class="form-group">
                                                            <label style="font-weight:bold" class="col-md-4 control-label" for="rs">Raison sociale *</label>
                                                            <div class="col-md-5">
                                                                <td><input type="text" name="rs" class="form-control" ></td>

                                                            </div>
                                                        </div><br><br>

                                                        <div style="font-weight:bold" class="form-group">
                                                            <label class="col-md-4 control-label" for="rc">Registre de commerce *</label>
                                                            <div class="col-md-5">
                                                                <td><input type="text" name="rc" class="form-control" ></td>

                                                            </div>
                                                        </div><br><br>

                                                        <div class="form-group">
                                                            <label style="font-weight:bold" class="col-md-4 control-label" for="fj">Forme Juridique *</label>
                                                            <div class="col-md-5">
                                                                <td><input type="text" name="fj" class="form-control" ></td>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="tables-clients.php"> <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button> </a>

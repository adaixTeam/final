                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li class="active"><a href="tables-employe.php"><i class="fa fa-user"></i>Employé</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            <li>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-clients.php">Les employés</a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font">ajouter un <strong>employé</strong></h1>
                                ...
                                <div id="page-wrapper">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <form action="adde.php" method="post" name="form1"><br><br>
                                                <fieldset>
                                                    <!-- Marque -->
                                                    <div class="form-group">
                                                    ...
                                                    <!-- Text input Couleur-->
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="telphone">Telephone *</label>
                                                        <div class="col-md-5">
                                                            <input type="tel" name="telphone" class="form-control" required>

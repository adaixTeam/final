...
{
$id = mysqli_real_escape_string($mysqli, $_POST['ide']);
	...
	if(empty($nom) || empty($email) || empty($telphone) || empty($post) || empty($cin)) {
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE employes SET nom='$nom',email='$email',post='$post',telphone='$telephoe',cin='$cin' WHERE ide=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM employes WHERE ide=$id");
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-clients.php">employés</a>
                                </li>
                                <li>
                                    <a href="#">Modifier employés</a>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>employés</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body">
                                  <!-- /.panel-heading -->
																	...
																	<form style="padding:3%;" name="form1" method="post" action="modifier_employe.php">
				                          <fieldset >
				                          ...
				                          <!-- Marque -->
															    ...
															    <!-- Text input Couleur-->
															    <div class="form-group">
															      <label class="col-md-4 control-label" for="telphone">N° Telephone</label>
															      <div class="col-md-5">
															    <input type="tel" name="telphone" class="form-control" value="<?php echo $telphone;?>">
				                          ...
				                          <div class="modal-footer">
				                            <a href="tables-employe.php"> <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button> </a>

                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li><a href="tables-datatables.php"><i class="fa fa-book"></i>Les Contrats</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Crée un<strong> Devis</strong></h1>
                                    <ul class="controls">
                                      ...
                                      <div class="col-lg-10">
                                          ...
                                          <section class="tile">
                                              <div class="tile-body" style="padding-left: 27%; padding-top: 5%;">
                                                  <form class="form-horizontal" role="form" action="affiche_devis.php" method="post">
                                                    ...
                                                    <hr>
                                                    <div class="form-group">
                                                      <label class="col-md-4 control-label" for="Nom">Date de livraison</label>
                                                      <div class="col-md-4">
                                                      <input  name="datel" type="date" placeholder="" class="form-control input-md" id="text1">
                                                      <span class="help-block"></span>
                                                      </div>
                                                    </div>
                                                    <div class="form-group">
                                                      <label class="col-md-4 control-label" for="textinput">Date de réception </label>
                                                      <div class="col-md-4">
                                                      <input  name="dater" type="date" placeholder="" class="form-control input-md" id="text3">
                                                      <span class="help-block"></span>
                                                      </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                      <label class="col-md-4 control-label" for="textinput">Durée de validité (en jours) </label>
                                                      <div class="col-md-4">
                                                      <input   name="duree" type="number" placeholder="" class="form-control input-md" id="duree" >
                                                      <span class="help-block"></span>
                                                      </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="col-md-4">
                                                      <input   name="prix" type="number" placeholder="Dhs" class="form-control input-md" id="Prix" >
                                                      <span class="help-block"></span>
                                                      </div>
                                                    </div>

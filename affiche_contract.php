...
$result1 = mysqli_query($mysqli, "SELECT * FROM users ORDER BY id DESC"); // using mysqli_query instead


if(isset($_POST['enregistrer']))
{
	$day = mysqli_real_escape_string($mysqli, $_POST['duree']);
	$price = mysqli_real_escape_string($mysqli, $_POST['prix']);
	$res = $day * $price;
	...
	//echo 'alert('.$res.')';
		...
		$datel = mysqli_real_escape_string($mysqli, $_POST['datel']);
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li><a href="tables-reservation.php"><i class="fa fa-edit"></i>Les Reservations</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li class="active"><a href="devis.php"><i class="fa fa-book"></i>Devis</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="ajoute_devis.php">Les Devis</a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font">ajouter un <strong>Devis</strong></h1>
																		<center><button class='btn btn-primary' style="margin-right: 17px;display: inline-block;" onclick="printContent('print')">Print&nbsp;&nbsp;&nbsp;<i class="fa fa-print"></i></button></center>
                                    <ul class="controls">
                  ...
                  <!-- Form Name -->
									<div id="print">
										...
										<address>
	    								<span class="muted">
											<h3 style="margin:-0.25em;"><strong>information sur l'agence</strong></h3><br>
	        						<span style="font-size:15px;color:#000;">Adresse:</span>  N° 6 2ème Etage Imm YASMINA Rue TOGO Ocean RABAT - Maroc <br>
	      							<span style="font-size:15px;color:#000;">Tél:</span>  <br>
	      							<span style="font-size:15px;color:#000;">Fix:</span>   +212(5) 37 73 73 24 <br>
	      							<span style="font-size:15px;color:#000;">E-mail:</span>  contact@marjanetech.com
	        						</span>
	        					</address>
									</div>
									<div style="display: inline-block;padding-left: 46%;"><img src="assets/images/logo_devis.png" alt="" style="width:100px;height:70px;margin-top:10;"></div>

                  		<hr>

                  		<div class="row">
                    	<center>
                      <h3><strong>CONTRAT N° : </strong> Devis pour location de voiture</h3></center>
											<center><h5><strong>Date du contrat</strong> : 2018-03-13</h5></center>
											<div style="display: inline-block;width: 45%;margin-left: 27px;margin-right: 10px;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                        	...
                        	<tr>
                          <th scope="row">Lieu de Livraison</th>
                          <td>
                            <?php echo $dater;?>
                          </td>
                        	</tr>
                        	<tr>
                          <th scope="row">Lieu de reprise</th>
                          <td>
                            <?php echo $duree;?> jours</td>
                        	</tr>
													<tr>
                          ...
                          <td>
                            <?php echo $duree;?> jours</td>
													...
													<tr>
                          <th scope="row">Durée de location</th>
                          <td>
                            <?php echo $duree;?> jours</td>
                        	</tr>
								...
								<table border="2" class="table table-striped table-hover">
									<tbody>
										...
										<tr>
											<th scope="row">Permis de conduire N°</th>
											<td>
												<?php echo $datel;?>
											</td>
										</tr>
										...
										<tr>
											<th scope="row">Nationnalité</th>
											<td>
												<?php echo $duree;?> jours</td>
										</tr>
										<tr>
											<th scope="row">C.I.N. N°</th>
											<td>
												<?php echo $prix;?> dhs/jour</td>
										</tr>
										<tr>
							...
							<div class="w3-panel w3-border" style="display: inline-block;width: 45%;margin-left: 27px;margin-right: 10px;">
							<center><h3><strong>PAIEMENT</strong></h3></center>
							<p>Mode de paiement :</p>
							<p>Frais de la location :</p>
							<p>Avance :</p>
							<p>Rest :</p>

  						</div>
							<div class="w3-panel w3-border" style="display: inline-block;width: 45%;margin-left: 27px;margin-right: 10px;">
							<center><h3><strong>ÉTAT DE LA VOITURE</strong></h3></center>
							<center><img src="assets/images/carburant.png" alt="carburant" width="42" height="42">&nbsp;&nbsp;<strong>Carburant</strong>&nbsp;&nbsp;<img src="assets/images/carburant2.jpg" alt="carburant" width="42" height="42"></center>
							<center><p>Km de Départ :</p></center>
							<center><p>AKm de Retour :</p></center>
  						</div>
							<div class="w3-panel w3-border" style="width: 45%;margin-left: 27px;margin-right: 10px;">
							<center><h3><strong>Signature du client au retour</strong></h3></center>
  						</div>

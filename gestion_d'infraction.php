...
$result = mysqli_query($mysqli, "SELECT * FROM reservation ORDER BY idr DESC"); // using mysqli_query instead
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>Infractions</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                            ...
                                            <iframe src=http://eprocess.mtpnet.gov.ma/InfractionWeb/web/#/login style="height:600px;width:100%;border:none"></iframe>

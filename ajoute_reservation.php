                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-reservation.php">Reservation</a>
                                </li>
                                <li>
                                    <a href="#">Ajouter Reservation</a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Ajouter une<strong> Reservation</strong></h1>
                                    <ul class="controls">
                            ...
                            <form action="addr.php" method="post" name="form1" style="padding:3%;">
                            <fieldset>

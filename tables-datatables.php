...
$result1 = mysqli_query($mysqli, "SELECT * FROM users WHERE st='0' ORDER BY id DESC");
$result2 = mysqli_query($mysqli, "SELECT * FROM reparation ORDER BY id DESC");
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li><a href="tables-factures.php"><i class="fa fa-user"></i>Employé</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                                            <!--<li>
            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <!-- col -->
                        <div class="col-md-12">
                            <button tabindex="0" style="font-weight:bold;padding:8px;border-radius:2px" class="btn btn-cyan" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-plus mr-5"></i> Ajoute une voiture</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 style="font-weight:bold" class="modal-title custom-font">Ajouter une Voiture</h3>
                    </div>
                        ...
                        <div id="page-wrapper">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form action="add.php" method="post" name="form1"><br><br>
                                        <fieldset>

                                            <!-- Marque -->
                                            <div class="form-group">
                                                <label style="font-weight:bold" class="col-md-4 control-label" for="Marque ">Marque  *</label>
                                                <div class="col-md-5">
                                                    <select  id="Marque" name="marque" class="form-control" required>
                                    <option style="display: none;" value="" >Marque</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="text" name="modele" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="color" name="couleur" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="text" name="matricule" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="text" name="numero" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="date" name="assurance" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="date" name="autorisation" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="date" name="visite" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="number" name="dernier" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="number" name="vidange" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="number" name="chaine" class="form-control">
                                            ...
                                            <option style="display:none;" value="">Carburant Moteur</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input style="padding:15px;font-weight:bold" type="number" name="prix" class="form-control">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button style="font-weight:bold" type="submit" class="btn btn-primary" name="Submit">Enregistrer</button>
                                        </div>
                                    </form>

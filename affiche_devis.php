...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
        ...
        <div id="wrap" class="animsition">
            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                  ...
                  <!-- Form Name -->
									<div id="print">
									<img src="assets/images/logo_devis.png" alt="" style="width:100px;height:70px;margin-top:10;">

                    <center>

                      <h4>  <?php
    echo  "Fait le "  . date("d/m/y") . "    A Rabat <br>";
    ...
    ?> </h4>
                  ...
                  <div class="row">
                    <br>
                    <div class="col-xs-12 tableinovice">
    ...
    <span class="muted">
        ...
        <span style="font-size:15px;color:#000;">Adresse:</span>  N° 6 2ème Etage Imm YASMINA Rue TOGO Ocean RABAT - Maroc <br>
      	...
      	<span style="font-size:15px;color:#000;">E-mail:</span>  contact@marjanetech.com
                    ...
                    <center>
                      <h3><strong>Intitulé : </strong> Devis pour location de voiture</h3></center>
                    <table border="5" class="table table-striped table-hover">
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">Prix total HT</th>
                          <td><input type="text" value="<?php echo $res;?>">dhs</td>
                        </tr>

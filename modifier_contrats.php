...
//getting id from url
		...
		$result = mysqli_query($mysqli, "SELECT * FROM contrats WHERE idcont=$id");
                                                    ...
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
												                        ...
												                        <ul>
												                            ...
												                            <li><a href="tables-cherche.html"><i class="fa fa-search"></i>Recherche</a></li>
																					 ...
																					 <li>
																							 <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
																							 <li><a href="tables-reservation_onligne.php"><i class="fa fa-align-justify"></i>Réservation Online</a></li>
																							 <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
																					 </li>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                  <!-- /.panel-heading -->
																	...
																	<form class="form-horizontal" action="modifier_contrats.php" method="post" name="form1">
																			 <fieldset>

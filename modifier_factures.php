...
//getting id from url
		...
		while($res = mysqli_fetch_array($result))
		{
			...
			$cinn = $res['cin2'];
			$nomm = $res['nom2'];
			$adressee = $res['adresse2'];
			$telephonee =$res['telephone2'];
			$permii =$res['permi2'];
			$delivree = $res['delivre2'];
			$villee = $res['ville2'];
			//Voiture
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li class="active"><a href="tables-factures.php"><i class="fa fa-paste"></i>Les Factures</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-factures.php.php">Les Factures</a>
                                </li>
                                <li>
                                    <a href="#">Modifier Facture</a>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Modifier <strong>Facture</strong></h1>
                                    <ul class="controls">
                                ...
                                <div class="tile-body">
                                  <!-- /.panel-heading -->
																	...
																	<form class="form-horizontal" action="tables-factures.php" method="post" name="form1">
																			 <fieldset>
																			 ...
																			 <div class="form-group">
																			   ...
																			   <div class="col-md-4">
																			     <input type="te"  name="cin" class="form-control"  value="<?php echo $cin;?>">
																			 ...
																			 <div class="form-group">
																			   ...
																			   <div class="col-md-4">
																			     <input type="text"  name="mode" class="form-control" value="<?php echo $mode;?>">
																			 ...
																			 <div class="modal-footer">
																			   <a href="tables-factures.php"> <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button> </a>

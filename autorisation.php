...
$result = mysqli_query($mysqli, "SELECT * FROM users where autorisation <= Now()");
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_client;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-lightred">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_car;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-blue">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_contrat;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-slategray">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_retour;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_assur;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_visite;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_reserv;?></p>
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo $ligne_auto;?></p>
          ...
          <div class="col-md-8" style="display: inline;float: none;">
            ...
            <section class="tile">
                ...
                <div class="tile-header dvd dvd-btm">
                    <h1 class="custom-font"><strong>Autorisation</strong> de circulation</h1>
                    <ul class="controls">
                              ...
                              while($res = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>".$res['marque']."</td>";
                                    ...
                                    echo "<td>".$res['matricule']."</td>";
                                      echo "<td>".$res['Carburant']."</td>";
                                    echo "<td>".$res['autorisation']."</td>";
                                echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"modifier_voitur.php?id=$res[id]\">Edit</a></td>";
                              }
                              ?>
                            </tbody>
                        </table>

...
$id = mysqli_real_escape_string($mysqli, $_POST['id']);
	$date = mysqli_real_escape_string($mysqli, $_POST['dateReparation']);
    $voiture = mysqli_real_escape_string($mysqli, $_POST['voiture']);
    $type = mysqli_real_escape_string($mysqli, $_POST['typeReparation']);
	$frais = mysqli_real_escape_string($mysqli, $_POST['frais']);
	$etat = mysqli_real_escape_string($mysqli, $_POST['etat']);

	// checking empty fields
	if(empty($date) || empty($voiture) || empty($type) || empty($frais) || empty($etat)) {
		...
		$result = mysqli_query($mysqli, "UPDATE reparation SET dateReparation='$date',voiture='$voiture',typeReparation='$type',frais='$frais',etat='$etat' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM reparation WHERE id=$id");

while($res = mysqli_fetch_array($result))
{
	$date = $res['dateReparation'];
    $voiture = $res['voiture'];
    $type = $res['typeReparation'];
	$frais = $res['frais'];
	$etat = $res['etat'];
}
?>
                    ...
                    <div class="page page-tables-datatables">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- tile -->
                                <section class="tile" style="width:80%;margin: 0 auto">
                                    ...
                                    <div class="tile-body" >
                                        ...
                                        <form style="padding:3%;" name="form1" method="post" action="modifier_reparation.php">
                                            <fieldset>
                                                <legend>Modifier un Client</legend>
                                                <!-- Marque -->
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="Nom Complete">Date de Réparation *  </label>
                                                    <div class="col-md-5">
                                                        <input type="text" name="dateReparation" class="form-control" value="<?php echo $date;?>">
                                                ...
                                                <!-- Text input Modèle-->
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="telephone">Voiture *</label>
                                                    <div class="col-md-5">
                                                        <input type="text" name="voiture" class="form-control" value="<?php echo $voiture;?>">
                                                    </div>
                                                </div><br><br>

                                                <!-- Text input Couleur-->
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="permi">Type de Réparation</label>
                                                    <div class="col-md-5">
                                                        <input type="text" name="typeReparation" class="form-control" value="<?php echo $type;?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="delivre">Frais de Réparation ( TTC )< *</label>
                                                    <div class="col-md-5">
                                                        <input type="number" name="frais" class="form-control" value="<?php echo $frais;?>">

                                                    </div>
                                                </div> <br><br>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="delivre">Circulation< *</label>
                                                    <div class="col-md-5">
                                            ...
                                            <div class="modal-footer">
                                                <a href="ajouter_reparation.php"> <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button> </a>

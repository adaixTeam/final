...
$result = mysqli_query($mysqli, "SELECT * FROM contrats where dateret <= Now() and st='0' "); // using mysqli_query instead
$zak = mysqli_query($mysqli, "SELECT * FROM clients2 where st='0' ORDER BY idc DESC"); // using mysqli_query instead
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                <li  class="active"><a href="tables-retour.php"><i class="fa fa-reply"></i>Confirmation de Retour</a></li>
                                                <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                  <!--a href="ajouter_contrat.php" tabindex="0" class="btn btn-success"><i class="fa fa-plus mr-5"></i> Ajoute une contrat</a!-->
                    	...
                    	while($res = mysqli_fetch_array($result)) {
                    		echo "<tr>";
                    		echo "<td>".$res['idcont']."</td>";
                        echo "<td>".$res['nom']."</td>";
                        echo "<td>".$res['cin']."</td>";
                    		echo "<td>".$res['telephone']."</td>";
                        echo "<td>".$res['matricule']."</td>";
                    		echo "<td>".$res['datedep']."</td>";
                    		echo "<td>".$res['dateret']."</td>";
                    		echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"confirmer_retour.php?id=$res[idcont]\"><i class='fa fa-thumbs-up'></i></a> </td>";
                    	}
                    	?>
                                            </tbody>
                                        </table>

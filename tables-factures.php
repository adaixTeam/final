...
$result = mysqli_query($mysqli, "SELECT * FROM contrats2 ORDER BY idcont DESC"); // using mysqli_query instead
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                    ...
                                                    <!--<li><a href="tables-bootstrap.html"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>!-->
                                                    <li class="active"><a href="tables-datatables.php"><i class="fa fa-paste"></i>Les Factures</a></li>
                                                    <!--<li><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>!-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font">Les <strong>Factures</strong></h1>
                                    <ul class="controls">
                                    <li class="dropdown">
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <table class="table table-custom" id="editable-usage">
                                            <thead>
                                            <tr>
                                              <th>Numero de factures</th>
                                              <th>Nom</th>
                                              <th >Date de facture</th>
                                              <th >Nom de voiture</th>
                                              <th>Dureé de location</th>
                                              <th >Totale TTC</th>
                                              <th >Avance</th>
                                              <th >Rest a payé</th>
                                              <th >Action</th>
                        ...
                        echo "<td>".$res['duree']."</td>";
                    		echo "<td>".$res['total']." Dhs</td>";
                        echo "<td>".$res['avance']." Dhs</td>";
                    		echo "<td>".$res['rest']." Dhs</td>";
                    		echo "<td><a style='background-color:#5cb85c;color:#fff;padding-bottom: 3px;padding-top: 2px;padding-right: 4px;padding-left: 4px;' href=\"modifier_factures.php?id=$res[idcont]\"><i class='fa fa-edit'></i></a></td>";
                    	}
                    	?>
                                            </tbody>
                                        </table>
